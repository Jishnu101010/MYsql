...
SELECT course, count(name) AS 'number of students' 
FROM studentss 
GROUP BY course;
...
SELECT name AS 'students from Chennai and Mumbai' FROM studentss 
WHERE city='Chennai' 
UNION 
SELECT name FROM studentss WHERE city='Mumbai';